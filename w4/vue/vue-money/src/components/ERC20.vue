...
import erc2612Addr from '../../deployments/dev/MyERC20.json'
import erc2612Abi from '../../deployments/abi/MyERC20.json'
  ...
  methods: {
    ...
    async permitDeposit() {
      ...
      try {
        ...
        // let namename = await this.bank.name();
        // console.log(namename);
        // this.erc20Token.name().then((r) => {
        //   console.log(r);
        // })
        // this.bank.balanceOf(erc2612Addr.address).then((r) => {
        //   console.log(r);
        // })
        let tx = await this.bank.depositPermit(erc2612Addr.address, amount, this.deadline, v, r, s);
      
        let receipt = await tx.wait();
        this.readContract();
      } catch (e) {
        alert("Error , please check the console log:", e.stack)
      }
